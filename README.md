...
## 画面（单页 React SPA · 桌面 1440×900 舞台缩放 / 手机竖屏阅读版）
...
└─ App.tsx          # 外壳：舞台/背景、路由、转场、主题、进度；useIsMobile 切手机版
