...
- **Daoist texts**: Dao De Jing chapters 1-50, selected passages from all seven Zhuangzi inner chapters, Qingjing Jing, Yinfu Jing, and the opening of Zhouyi Cantong Qi.
...
- full Dao De Jing chapters 51-81
...
- Complete Dao De Jing and deepen Zhuangzi, Platform Sutra, and Ten Wings coverage.
...
- `scripts/build_ten_wings.mjs` extracts the complete Ten Wings source text from [bollwarm/ZHOUYI](https://github.com/bollwarm/ZHOUYI), also converted through `opencc-js`; the current full corpus is source text only, while selected Ten Wings passages carry project-written vernacular glosses.
