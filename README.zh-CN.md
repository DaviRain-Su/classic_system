...
| **多章经文** | 道德经(前三十章)/庄子(内篇七篇精选)/六祖坛经(八品精选)：左章目录、右逐句点读。 |
...
- **道家**（7）：道德经前三十章 · 庄子内篇七篇精选 · 常清静经 · 阴符经 · 参同契开篇（列子/太乙占位）；
...
1. **（已上线）原型骨架 + 样板内容**：见上表。
2. **《周易》核心已做完**：64 卦全卦爻辞 ✓ 白话 ✓、彖/大象/小象白话(64+64+384) ✓、爻位承乘比应 ✓、历代易注(卦辞64+爻级386) ✓、十翼精读互跳 + 全文底本 ✓；尚余「做厚」：十翼全文白话/逐句注、道德经 31-81 章、各家其余经典。
