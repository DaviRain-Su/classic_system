...
| **经卷长轴 · 全卦** | **六十四卦全文可读**：卦辞 + 彖 + 大象 + 爻辞 + 白话 + 小象；乾/坤/泰/否/既济/未济六卦为精读样板，另含更完整的逐爻交互、爻位分析、用九/用六、历代集注、卦族与卦变。 |
...
1. **（已上线）原型骨架 + 样板内容**：见上表。
2. **内容做厚**：64 卦全卦爻辞 ✓ + 白话 ✓ + 历代易注(程颐·朱熹，**卦辞级 64/64 + 爻级 386 条**) ✓；尚余十翼全文（说卦/序卦/杂卦）、道德经 81 章、各家其余经典。
