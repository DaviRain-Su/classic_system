...
| **多章经文** | 道德经(全 81 章)/庄子(内篇七篇加厚精选)/六祖坛经(八品精选)：左章目录、右逐句点读。 |
...
- **佛家**（7，汉传/藏传/导读）：心经 · 金刚经 · 维摩诘·不二 · 八识规矩颂 · 六祖坛经八品精选｜入菩萨行论｜正见·四法印（依宗萨钦哲《正见》导读，非原文转录）；
- **西方对照枝**：9 条（含群论 GF(2)）。

## 路线图

1. **（已上线）原型骨架 + 样板内容**：见上表。
2. **《周易》核心已做完**：64 卦全卦爻辞 ✓ 白话 ✓、彖/大象/小象白话(64+64+384) ✓、爻位承乘比应 ✓、历代易注(卦辞64+爻级386) ✓、十翼精读互跳 + 全文底本 ✓；**道德经 81 章已补齐**；庄子内篇已加厚精选；尚余「做厚」：十翼全文白话/逐句注、道德经历代注、各家其余经典。
