...
export const XICI: ClauseWork = {
  ...
  intro: '《系辞》为孔门解《易》之作，纵论易道之本——“一阴一阳之谓道”，正是中国系统思维的总纲。',
  clauses: [
    { text: '天尊地卑，乾坤定矣。卑高以陈，贵贱位矣。', gloss: '天高地下，乾坤之位即定；高下既陈，贵贱之序乃明。' },
    { text: '一阴一阳之谓道。', gloss: '阴阳交替、相反相成，便是“道”——万象皆由此二者生发。' },
    { text: '易有太极，是生两仪，两仪生四象，四象生八卦。', gloss: '太极一分为阴阳两仪，再分四象、八卦——一套层层倍生的系统。', link: { kind: 'cube', label: '看八卦如何层层倍生' } },
    { text: '形而上者谓之道，形而下者谓之器。', gloss: '超越形体的是“道”（规律），落于形体的是“器”（事物）。' },
    { text: '生生之谓易。', gloss: '生而又生、化育不息，就是“易”的本义。' },
    { text: '易与天地准，故能弥纶天地之道。', gloss: '《易》与天地相齐，故能统贯天地之理。' },
    { text: '穷则变，变则通，通则久。', gloss: '事至穷尽则生变，变则通达，通则长久——系统自我更新之理。' },
  ],
};
...
export const SHUOGUA: ClauseWork = {
  ...
  clauses: [
    { text: '天地定位，山泽通气，雷风相薄，水火不相射，八卦相错。', gloss: '八卦两两相对而交感（先天方位）：天地上下定位、山泽气息相通、雷风相互激荡、水火并行不悖——八卦交错而成象。', link: { kind: 'square', label: '于先天方圆图看八卦相错' } },
